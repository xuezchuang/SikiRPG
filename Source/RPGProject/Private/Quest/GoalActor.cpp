...
AGoalActor::AGoalActor()
{
	...
	static ConstructorHelpers::FObjectFinder<UPaperSprite> Sprite(TEXT("PaperSprite'/Game/Textures/QuestTextures/NpcIcon_Sprite.NpcIcon_Sprite'"));
	MiniMapIcon->SetSprite(Sprite.Object);

	MiniMapIcon->SetRelativeLocation(FVector(0,0,150.0f));
	...
	static ConstructorHelpers::FObjectFinder<UPaperSprite> AreaSprite(TEXT("PaperSprite'/Game/Textures/QuestTextures/GoalCircle_Sprite.GoalCircle_Sprite'"));
	MiniMapAreaIcon->SetSprite(AreaSprite.Object);
	MiniMapAreaIcon->SetRelativeLocation(FVector(0, 0, 150.0f));
